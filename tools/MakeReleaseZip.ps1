...
# Creates a zip file from the release folders of the CollectionsDesktop and
# CollectionsUniversal projects, versioning the file using the
...
# Source paths
$AssemblyInfoPath = "..\src\CollectionsUniversal\Properties\AssemblyInfo.cs"
$UniversalAnyPath = "..\src\CollectionsUniversal\bin\Release"
$UniversalARMPath = "..\src\CollectionsUniversal\bin\ARM\Release"
$Universalx86Path = "..\src\CollectionsUniversal\bin\x86\Release"
$Universalx64Path = "..\src\CollectionsUniversal\bin\x64\Release"
$DesktopPath = "..\src\CollectionsDesktop\bin\Release\"
...
Get-Content $AssemblyInfoPath | ForEach-Object {
	if ($_ -match "AssemblyVersion") {
		...
		$OutputFile = $OutputPath + "NerdyDuck.Collections_" + $FileVer.ToString(3) + ".zip"
	}
}
